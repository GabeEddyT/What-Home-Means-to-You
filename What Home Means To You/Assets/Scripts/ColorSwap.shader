Shader "SmkGames/ColorReplacement"
{
	...
	[HideInInspector] _color("Color", Color) = (1.0,1.0,1.0,1.0)
		...
		_Red("Filter Color 1", Color) = (1.0,0,0,1.0) //Red
		_Green("Filter Color 2", Color) = (0,1.0,0,1.0) //Green
		_Blue("Filter Color 3", Color) = (0,0,1.0,1.0) //Blue
		_Yellow("Filter Color 4", Color) = (1.0,1.0,0,1.0) //Yellow
		_Purple("Filter Color 5", Color) = (1.0,0,1.0,1.0) //Purple
		_Cyan("Filter Color 6", Color) = (0,1.0,1.0,1.0) //Cyan
		_White("Filter Color 7", Color) = (1.0,1.0,1.0,1.0) //Cyan
